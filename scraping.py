...
def mission_to_mars(browser):
    ...
    domain = 'https://marshemispheres.com/'
    ...
    for i in range(4):
        ...
        # Click into article and set html object to that article's page
        ...
        image = article_soup.find('img', class_='wide-image')
        image_url = domain + image.get('src')
        title = article_soup.find('h2', class_='title').get_text().strip()
